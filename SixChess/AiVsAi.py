...
def main():
    ...
    computer1 = AI(Line_Points, BLACK_CHESSMAN)
    computer2 = AI(Line_Points, WHITE_CHESSMAN)
    ...
    while True:
        ...
        computer2.get_opponent_drop(AI_point2)
        AI_point1 = computer2.AI_drop()
        winner = checkerboard.drop(cur_runner, AI_point1)
        AI_point2 = computer2.AI_drop()
        winner = checkerboard.drop(cur_runner, AI_point2)

        if winner is None:
            cur_runner = _get_next(cur_runner)
            computer1.get_opponent_drop(AI_point1)
            computer1.get_opponent_drop(AI_point2)
            AI_point1 = computer1.AI_drop()
            winner = checkerboard.drop(cur_runner, AI_point1)
            AI_point2 = computer1.AI_drop()
            winner = checkerboard.drop(cur_runner, AI_point2)
